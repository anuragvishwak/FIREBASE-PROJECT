...
function Cuisine() {
  return (
    <div className=' bg-[#00a676] ml-10 rounded-tr-full rounded-tl-full mr-10  p-3'>
        ...
        <Link to='/Chinese'>
            <div className='bg-white  p-2 rounded-tl-full rounded-tr-full'>
            <img className='rounded-full h-80  w-80 mb-5' src={img1}/>
            <p className='text-2xl  font-[400]'>CHINESE CUISINE</p>
            </div>
        </Link> 
            ...
            <p className='text-2xl italic font-[400]'>SOUTH INDIA CUISINE</p>
            </div>
            </Link>
            ...
            <p className='text-2xl font-[400]'>PUNJABI CUISINE</p>
            </div>
            </Link> 
            ...
            <p className='text-2xl  font-[400]'>MAHARASTRIAN CUISINE</p>
            </div>
            </Link>
        </div>
    </div>
